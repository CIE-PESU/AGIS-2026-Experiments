...
from app.exceptions.base import KafkaPublishError  # Extends AppException as per Parthiv's task
from app.kafka.payloads import KafkaBasePayload
...
class KafkaProducerClient:
    ...
    async def publish(self, topic: str, payload: KafkaBasePayload) -> str:
        """
